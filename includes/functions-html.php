...
function yourls_html_logo() {
	...
	<header role="banner">
	<h1>
		<a href="<?php echo yourls_admin_url( 'index.php' ) ?>" title="MPgo.io">
		<img src="<?php yourls_site_url(); ?>/images/yourls-logo.png" alt="MPgo.io" title="MPgo.io" border="0" style="border: 0px;width: 100px;" /></a>
	</h1>
	</header>
	<?php
...
function yourls_html_head( $context = 'index', $title = '' ) {
	...
	// Page title
	$_title = 'MPgo.io &mdash; URL Shortener';
...
<head>
	...
	<meta name="generator" content="MPgo.io <?php echo YOURLS_VERSION ?>" />
	<meta name="description" content="MPgo.io &raquo; URL Shortener" />
	...
	<link rel="stylesheet" href="<?php yourls_site_url(); ?>/css/style.css" type="text/css" media="screen" />
	<?php if ( $tabs ) { ?>
	...
	<?php } ?>
	<?php if ( $tablesorter ) { ?>
		<link rel="stylesheet" href="<?php yourls_site_url(); ?>/css/tablesorter.css" type="text/css" media="screen" />
	...
	<div id="new_url">
		<div>
			<form id="new_url_form" action="" method="get">
				<div><strong><?php yourls_e( 'Enter URL' ); ?></strong>:<input type="text" id="add-url" name="url" value="<?php echo $url; ?>" class="text" size="80" placeholder="http://" />
				<strong id="custom_url"><?php yourls_e('Custom URL'); ?></strong><?php yourls_e( ' ('.'Optional'.')'); ?>:<input type="text" id="add-keyword" name="keyword" value="<?php echo $keyword; ?>" class="text" size="8" />
				<?php yourls_nonce_field( 'add_url', 'nonce-add' ); ?>
				<input type="button" id="add-button" name="add-button" value="<?php yourls_e( 'Generate URL' ); ?>" class="button" onclick="add_link();" /></div>
			</form>
...
function yourls_share_box( $longurl, $shorturl, $title = '', $text='', $shortlink_title = '', $share_title = '', $hidden = false ) {
	if ( $shortlink_title == '' )
		$shortlink_title = '<h2>' . yourls__( 'Minified Link' ) . '</h2>';
	if ( $share_title == '' )
