...
define( 'YOURLS_DB_USER', 'mpurls' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', '7FN2Kber9DHq' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'mpgoio_urls' );
...
/** MySQL tables prefix */
define( 'YOURLS_DB_PREFIX', 'mpgoio_urls_' );
...
define( 'YOURLS_SITE', 'http://mpgo.io' );
...
$yourls_user_passwords = array(
	'bbaldridge' => 'phpass:!2a!08!kQxXkZzvNI8f9mw3vHGefeV1b5fKrpLz4HUB5y9LxIEF0Gp52gYEG' /* Password encrypted by YOURLS */ ,
	// 'username2' => 'password2',
